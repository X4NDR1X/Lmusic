...
$nome = $_POST['Nome'];
$data = $_POST['Data'];
$nome_arquivo = $_FILES['arquivo_imagem'];
$descricao = $_POST['descricao'];
$arquivo_blob = file_get_contents($nome_arquivo['tmp_name']);

$termo = $nome;

$retornoInserir = InserirServico($conexao, $nome, $descricao, $arquivo_blob, $data);
?>
...
<body>
    ...
    <div id="content">
        <div id="forms">
            ...
            <a href="albuns.php?idUsuario=<?php echo htmlspecialchars($idUsuario); ?>&nome=<?php echo urlencode($nome); ?>"
                id="aref">
                Lista de Álbuns
            </a>
        </div>
