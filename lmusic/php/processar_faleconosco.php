...
$RetornoFaleConosco = FaleConosco($conexao, $nome, $email, $mensagem);
?>
...
<body>
    ...
    <div id="content">
        <div id="forms">
            <?php
            if ($RetornoFaleConosco){
                echo "Mensagem enviada com sucesso! Obrigado por entrar em contato conosco!";
            ?>
                <a href="index.php?idUsuario=<?php echo htmlspecialchars($idUsuario); ?>" id="aref">Menu Inicial</a>
            <?php

            } else {
                echo "Erro ao enviar a mensagem!";
            ?>
                <a href="faleconosco.php?idUsuario=<?php echo htmlspecialchars($idUsuario) ?>" id="aref">Voltar</a>
            <?php
            }
            ?>
            <br>
