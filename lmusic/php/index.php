...
<body>
  ...
  <div id="content">
    <div id="content1">
      <div id="guitarist">
        <figure>
          <img src="../images/guitarist.png" alt="" height="500px" />
        </figure>
      </div>

      <div id="content1_text">
        <div class="shadow-dance-container">
          <h1 class="shadow-dance-text">LMUSIC</h1>
        </div>
        <h2 id="content1_text_h2">
          Descubra o universo da música com a <br>
          <strong>LMUSIC!</strong> Aqui você encontra <br>
          conteúdos, dicas e novidades que inspiram <br>
          e aproximam ainda mais do som que você ama. <br>
          Seja para aprender, explorar estilos ou ficar por <br>
          dentro das tendências, a LMUSIC é o seu espaço <br>
          para viver a música de forma única. 🎶
        </h2>
      </div>
    </div>
  </div>
