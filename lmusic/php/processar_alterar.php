...
<head>
    ...
    <title>Formulário para carregar imagem</title>
...
<body>
    ...
    <div id="content">
        <div id="forms">
            ...
            <?php
            if (AlterarAlbum($conexao, $idServico, $nome, $descricao, $data)) {
                echo "Álbum alterado com sucesso!";
            ?>
                <a href="albuns.php?idUsuario=<?php echo htmlspecialchars($idUsuario); ?>" id="aref">Álbuns</a>
            <?php
            } else {
                echo "Erro ao alterar álbum!";
            ?>
                <a href="alterar.php?idUsuario=<?php echo htmlspecialchars($idUsuario); ?>" id="aref">Voltar</a>
            <?php
            }
            ?>
