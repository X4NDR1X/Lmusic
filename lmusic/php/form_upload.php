...
<body>
    ...
    <div id="content">
        <div id="forms">
            <form action="processar_form_upload.php" method="post" enctype="multipart/form-data">
                <legend>Inserir Álbum</legend><br><br>
                ...
                <input type="file" name="arquivo_imagem" required><br><br>
