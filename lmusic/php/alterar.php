...
$dadosAlbum = DadosServico($conexao, $idServico);
?>
...
<head>
    ...
    <title>Formulário para alterar álbum</title>
...
<body>
    ...
    <div id="content">
        <div id="forms">
            <form action="processar_alterar.php" method="post" enctype="multipart/form-data">
                <legend>Alterar Álbum</legend><br><br>

                <label>Nome</label><br>
                <input type="text" name="Nome" required value="<?= $dadosAlbum['Nome'] ?>"><br><br>

                <label>Data de upload:</label><br>
                <input type="date" name="Data" required value="<?= $dadosAlbum['Data'] ?>"><br><br>

                <label>Descrição</label><br>
                <input id="desc" type="text" name="Descricao" required value="<?= $dadosAlbum['Descricao'] ?>"><br><br>

                <input type="number" name="idUsuario" value="<?php echo htmlspecialchars($idUsuario); ?>" hidden>
                <input type="number" name="idServico" value="<?php echo htmlspecialchars($idServico); ?>" hidden>
